  ...
  return (
    ...
    >
      <g>
        ...
        <text x="10" y="40" fill="black" className="font-medium font-Inter text-xs">Nasdaq</text>
        <text x="56" y="40" fill="#4f4c48" className="font-thin font-Inter text-xs">Listed</text>
      </g>
